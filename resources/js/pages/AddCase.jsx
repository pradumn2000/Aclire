...
//     if (!row.dob && !row.candidate_dob)        { errors.push(`Row ${i + 2}: missing date of birth`); return; }
//     rows.push({
...
//       candidate_dob:    row.dob || row.candidate_dob,
...
//   <button className="secondary-cta import" onClick={() => setShowBulkModal(true)}>
//     <img src="images/dashboard/export-excel.svg" alt="" /> Bulk Upload
//   </button>
//   <button className="secondary-cta import" onClick={() => navigate(isClientUser ? "/Client?tab=all" : "/AllCases")}>
//     ← All Cases
//   </button>
...
//               candidate_name, candidate_email, mobile, dob, position, checks, billing_mode, client_name
//             </code><br />
...
//               <code>dob</code> is required in <code>YYYY-MM-DD</code> format.
//             </span>
//           </div>
...
//                       {["Candidate", "Email", "DOB", "Checks", "Billing"].map(h => (
...
//           </p>
//           <button className="primary-cta" onClick={() => { closeBulkModal(); navigate(isClientUser ? "/Client?tab=all" : "/AllCases"); }}
...
function caseToForm(c, fallback) {
  return {
    ...
    DOB:             c.candidate_dob || c.dob || fallback.DOB,
