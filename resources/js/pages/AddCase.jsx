...
export default function AddCase() {
  ...
  // ─────────────────────────────────────────────────────────────
  // SUCCESS SCREEN - FIXED REDIRECT FOR CLIENT
  // ─────────────────────────────────────────────────────────────
  if (submitted) {
    return (
      <>
            ...
            <div className="dash-wrper">
              <div className="ac-success-wrap">
                <div className="ac-success-card">
                  ...
                  <div className="ac-success-actions">
                    {/* CHANGED: Now redirects Client to /Client instead of /ClientCases */}
                    <button 
                      className="primary-cta" 
                      onClick={() => navigate(isClientUser ? "/Client" : "/AllCases", { state: { refresh: true } })}
                    >
                      View All Cases
                    </button>
                    <button className="secondary-cta import" onClick={handleReset}>
        ...
        <main>
          <div className="dash-wrper">
            ...
            <div className="dash-upper-head">
              ...
              <div className="right">
                {/* CHANGED: Now redirects Client to /Client */}
                <button className="secondary-cta import" onClick={() => navigate(isClientUser ? "/Client" : "/AllCases")}>
                  ← All Cases
                </button>
              </div>
            </div>
            ...
            <div className="ac-layout">
              ...
              <div className="ac-left">
                {/* ... All your form fields (Candidate Info, Billing Mode, etc.) remain unchanged ... */}
              </div>

              {/* RIGHT COLUMN - Your existing code */}
              <div className="ac-right">
                {/* ... All your check types, notes, summary, submit button remain unchanged ... */}
              </div>
            </div>
          </div>
        </main>
