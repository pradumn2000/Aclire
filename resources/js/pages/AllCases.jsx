...
// // // ── Same helpers/config as Client.jsx, so the detail panel behaves
// // //    identically no matter which page opened it ──────────────────────────
// // const CHECK_BADGE = {
...
// //   // ── Helpers for the detail panel (same logic as Client.jsx) ─────────────
...
// //   // ── Check-wise Status grid (identical to Client.jsx) ─────────────────────
...
// //   // ── Timeline (identical to Client.jsx) ────────────────────────────────────
...
// //   // ── Case detail panel (identical structure to Client.jsx) ────────────────
...
// //             {/* ── List + Detail split, same layout class as Client.jsx ──────── */}
// //             <div className="dash-inner-wrp-both client-portal" style={{ marginTop: "16px" }}>
...
// //                                 <td>{row.candidate}</td>
// //                                 {isAdmin && <td>{row.client}</td>}
// //                                 <td style={{ fontSize: "12px", color: "#475569" }}>{displayChecks(row.checks)}</td>
// //                                 <td>
// //                                   <span className={`status ${row.status}`}>{statusLabel(row.status)}</span>
// //                                 </td>
// //                                 <td>
