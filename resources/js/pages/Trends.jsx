      ...
      <section id="content">
        ...
        <main>
          <div className="dash-wrper">
            ...
            <div className="apg-dash-table-section">
              <div className="apg-dash-table-header">
                <div className="apg-dash-table-title">DATE-WISE CASE LOG — This Month</div>
                <div className="apg-dash-table-actions">
                  <button className="primary-cta" id="apg-btn-csv">CSV</button>
                  <button className="secondary-cta" id="apg-btn-excel">Excel / PDF</button>
                </div>
              </div>
                ...
                <table className="apg-dash-table">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>28</td><td>21</td>
                      <td className="text-red font-medium">2</td>
                      <td>1</td><td>4.1d</td><td>93%</td>
                    </tr>
                    <tr>
                      <td className="apg-dash-td-date">02 May 2026</td>
                      <td>32</td><td>18</td>
                      <td className="text-red font-medium">3</td>
                      <td>0</td><td>4.8d</td><td>91%</td>
                    </tr>
                    <tr>
                      <td className="apg-dash-td-date">03 May 2026</td>
                      <td>24</td><td>30</td>
                      <td className="text-gray">1</td>
                      <td>2</td><td>5.2d</td><td>96%</td>
                    </tr>
                  </tbody>
                </table>
              </div>
